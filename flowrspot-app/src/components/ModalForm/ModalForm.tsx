...
import { setIsLoginModalActive, setIsLoginSuccessModalActive, setIsModalActive, setIsProfileModalActive, setIsRegisteredSuccessModalActive, setIsRegisterModalActive } from '../../store/commonSlice/commonSlice';
import { getLoginModalStatus, getLoginSuccessModalStatus, getModalStatus, getProfileModalStatus, getRegisterModalStatus, getRegisterSuccessModalStatus } from '../../store/commonSlice/selectors';
